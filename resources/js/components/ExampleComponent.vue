      ...
      <div class="container pt-5">
        <div class="row justify-content-center">
          <div class="col-12 text-center">
            <h1 class="pb-4">
              Choose <i class="uil uil-bus color-yellow"></i> ticket
            </h1>
            <div class="section">
              <input
                class="checkbox-ticket"
                type="radio"
                name="ticket"
                id="ticket-1"
              />
              ...
              <label for="ticket-2">
                ...
                <span class="price mt-2 pb-4 mb-3"> <sup>$</sup>4.95 </span>
                <span class="section dots">
                  <span></span>
                  <span></span>
                  <span></span>
                ...
                <span class="time mt-2"> 2:00 pm - 3:00 pm </span>
                <span class="bottom-dots">
                  <span class="section dots">
                    <span></span>
                    <span></span>
              ...
              <label for="ticket-3">
                ...
                <span class="price mt-2 pb-4 mb-3"> <sup>$</sup>6.95 </span>
                <span class="section dots">
                  <span></span>
                  <span></span>
                  <span></span>
                ...
                <span class="time mt-2"> 2:00 pm - 3:30 pm </span>
                <span class="bottom-dots">
                  <span class="section dots">
                    <span></span>
                    <span></span>
              ...
              <div class="w-100"></div>
              <a href="#" class="btn mt-4 mb-5"
                ><i class="uil uil-ticket size-22 mr-2"></i>Buy Ticket</a
              >
            </div>
          </div>
        </div>
