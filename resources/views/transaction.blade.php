 ...
 */
    body {
        background: url('https://i.pinimg.com/originals/4a/08/4d/4a084d639e013d7d8fc5a9bed4d60dfb.gif');
            ...
            <div class="ticket" aria-hidden="true">
                <div class="ticket__header">
                    <div class="ticket__co">
                        ...
                        <span class="ticket__co-name">Castle</span>
                        <span class="u-upper ticket__co-subname">15€ Early Bird</span>
                    </div>
                </div>
                <div class="ticket__body">
                    <p class="ticket__route">Veschlüsseltes System</p>
                    <p class="ticket__description">Garten Eden</p>
                    <div class="ticket__timing">
                        <p>
                            <span class="u-upper ticket__small-label">Date</span>
                            <span class="ticket__detail">Nov 27</span>
                        </p>
                        <p>
                            <span class="u-upper ticket__small-label">Launch</span>
                            <span class="ticket__detail">23:00</span>
                        </p>
                        <p>
                            <span class="u-upper ticket__small-label">Line Up</span>
                            <span class="ticket__detail">xephereth</span>
                        </p>
                    </div>
                    <br>
                    <select name="ticketAmount" id="select_id">
                    ...
                    <img src="https://media1.giphy.com/media/ghiMEnnnIE5xe/200.gif" alt="">
                    <br>
                    <a class="btn btn-dark m-3" onclick="document.getElementById('form').submit();">Pay <b id="payment"></b> Tickets</a>
